    ...
    >
      ...
      >
        <div style={{ flex: '0 0 58vw' }}>
          ...
          <img
            src={`${base}screen-map.jpg`}
            crossOrigin="anonymous"
            alt="Network map screenshot"
            style={{
              width: '58vw',
              height: '58vh',
              objectFit: 'cover',
        ...
        <div style={{ flex: 1, paddingTop: '6vh' }}>
          <div style={{ marginBottom: '3vh' }}>
            ...
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.5 }}>
              Teardrop pin markers colored by device status — clustering for dense areas
            </div>
          </div>
          <div style={{ marginBottom: '3vh' }}>
            <div
            ...
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.5 }}>
              Green=online · Amber=degraded · Red=offline · Gray=unknown
            </div>
          </div>
          <div style={{ marginBottom: '3vh' }}>
            <div
            ...
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.5 }}>
              Customer filter, status filter, layer toggles, status count summary
            </div>
          </div>
          <div>
            <div
            ...
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.5 }}>
              latitude/longitude/geoSource on sites + managed_devices. All 14 seeded sites have real
              WGS-84 coords.
            </div>
          </div>
        </div>
