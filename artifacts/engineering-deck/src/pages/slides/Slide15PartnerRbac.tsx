      ...
      >
        <div style={{ flex: '0 0 26vw' }}>
          ...
          <div style={{ marginBottom: '2.5vh' }}>
            ...
            <div style={{ color: '#666666', fontSize: '1.25vw', lineHeight: 1.7 }}>
              Partner org links to customers via telecomServicesPartnerId. On login, auth middleware
              injects req.partnerCustomerIds[] — all API list routes filter by inArray(customerId,
              pIds).
            </div>
          </div>
          <div style={{ marginBottom: '2.5vh' }}>
            ...
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.7 }}>
              No writes on tickets, services, customers
            </div>
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.7 }}>
              Controllers, network-links, events: 403
            </div>
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.7 }}>
              Internal customer notes stripped
            </div>
            <div style={{ color: '#666666', fontSize: '1.2vw', lineHeight: 1.7 }}>
              InternalOnlyRoute blocks /dashboard, /admin
            </div>
          </div>
          <div>
            <div
            ...
            <div style={{ fontFamily: 'monospace', fontSize: '1.2vw', color: '#666666' }}>
              Acme123! — sees 2 customers
            </div>
          </div>
        </div>
        <div style={{ flex: 1 }}>
          <img
            src={`${base}screen-admin.jpg`}
